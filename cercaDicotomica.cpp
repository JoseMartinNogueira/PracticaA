...
int main() {
  ...
  if (dicc and ent) {
    ...
    cout << "Temps d'execució de l'algoritme de Cerca Dicotòmica: " << (hash_2-hash_1)/double(CLOCKS_PER_SEC)*1000 << endl;
    ...
    cout << "Mitjana aritmètica de comparacions totals: " << comp / numComp.size() << endl;
